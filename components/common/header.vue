<template>
  <div>
    ...
    <div class="max-w-screen-xl xl:px-10 px-2 m-auto font-bold text-center">
      <n-link to="/cities">
        <img class="inline h-5 my-1" src="~/assets/icons/market.png" alt="Icon"> Market
      </n-link>
      <n-link to="" class="pl-6">
        <img class="inline h-5 my-1" src="~/assets/icons/flash_sales.png" alt="Icon"> Flash Sales
      </n-link>
      <n-link to="" class="pl-6">
        <img class="inline h-5 my-1" src="~/assets/icons/festivals.png" alt="Icon"> Festivals
      </n-link>
      <n-link to="" class="pl-6">
        <img class="inline h-5 my-1" src="~/assets/icons/discount.png" alt="Icon"> Discount
      </n-link>
    </div>
  </div>
</template>
