                    ...
                    <div class="grid grid-cols-3 gap-4 items-center justify-center">
                        ...
                        <div>
                            ...
                            <div class="flex flex-col w-2/3">
                                <button class="btn-border bg-green-3 focus:outline-none mt-4">Buy now</button>
                                <button class="btn-border focus:outline-none mt-4">Add to bag</button>
                            </div>
                        </div>
                        <div class="flex items-center justify-center">
                            <button class="focus:outline-none"><i class="ri-delete-bin-2-fill text-gray-4 text-2xl"></i></button>
                        </div>
                    </div>
