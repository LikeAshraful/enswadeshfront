        ...
        <div class="bg-white">
            <div class="p-4 grid md:grid-cols-3 gap-4 items-center">
                <div class="flex items-center gap-4">
                    ...
                    <select class="w-16 border border-gray-4 rounded focus:outline-none py-1 px-2">
                        <option>5</option>
                ...
                <table class="w-full">
                    ...
                    <tbody class="px-4">
                        <tr v-for="(item, index) in items" :key="index">
                            <td><n-link :to="`/shop/control-panel/view-order/${index}`" class="font-bold text-blue-1">#000{{index}}</n-link></td>
                            <td>
                                <div class="flex gap-1">
                                    <img class="h-10 w-12" src="~/assets/img/default_market.png" alt="">
                                    <img class="h-10 w-12" src="~/assets/img/default_market.png" alt="">
                                </div>
                            </td>
                            <td>COD</td>
