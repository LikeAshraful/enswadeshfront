        ...
        <div class="p-2 grid grid-cols-2 gap-8">
            ...
            <div>
                <div class="border border-purple-2 rounded-xl w-1/2 m-auto mt-12">
                    <p class="bg-purple-2 text-white text-center py-2 rounded-t-xl">Required Documents</p>
                ...
                <p class="w-1/2 m-auto">Our team will collect these documents from you and verify your store.</p>
            </div>
        </div>
    </div>
</template>
