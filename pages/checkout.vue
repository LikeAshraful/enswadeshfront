      ...
      <div class="grid sm:grid-cols-2 sm:gap-8 py-4">
        <div class="">
          ...
          <div class="px-2 py-4">
            ...
            />
            <p class="inline mr-4">I have already an account.</p>
            <button
              @click="showLoginModal"
              class="focus:outline-none font-bold text-orange-1"
            >
              Login
            </button>
          </div>
        ...
        <div>
          ...
          <n-link to="/order-complete" class="bg-green-3 btn block"
            >Place Order</n-link
          >
      </div>
    </div>
