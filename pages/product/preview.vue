<template>
    <div>
        ...
        <!-- Product Details -->{{getProductPreviewData}}
        <div class="grid sm:grid-cols-7 lg:gap-12 md:gap-4 sm:gap-2 py-4">
            <div class="sm:col-span-2">
                <div class="relative pb-full">
                    <!-- <img class="absolute h-full w-full object-cover" :src="getProductPreviewData.thumbnail ? basePath + '/storage/' + getProductPreviewData.thumbnail : require(`~/assets/img/products/default.png`)" alt="Image"> -->
                </div>

                    <div class="grid grid-cols-4 gap-2 mt-2">
                    <!-- <div class="relative pb-3/4" v-for="(photo, i) in getProductPreviewData.image" :key="i">
            ...
            <div class="sm:col-span-3 sm:mt-0 mt-4">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="font-semibold">
                              <span>{{ getProductPreviewData.discount_price }} {{getProductPreviewData.currency_type}}</span>
                              <span v-if="getProductPreviewData.discount" class="text-gray-4 ml-4 line-through">{{getProductPreviewData.price}} {{getProductPreviewData.currency_type}}</span>
                            </td>
                        </tr>
                        <tr>
                            <td>Stock:</td>
                            <td v-if="getProductPreviewData.stocks > 0" class="font-semibold">Available</td>
                            <td v-else class="text-red-500 font-semibold">Unavailable</td>
                        </tr>
                        <tr>
                            <td>Brand:</td>
                            <td class="font-semibold">{{getProductPreviewData.brand? getProductPreviewData.brand.name : ''}}</td>
                        </tr>
                        <tr>
                            <td>SKU:</td>
                ...
                <div v-if="getProductPreviewData.offers">
                ...
                <div class="flex gap-3 justify-between">
                    ...
                    <button v-if="getProductPreviewData.can_bargain" @click="bargainModal" class="focus:outline-none border rounded border-gray-3 py-1 font-semibold w-full">Bargain</button>
