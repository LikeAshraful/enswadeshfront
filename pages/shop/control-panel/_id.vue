            ...
            <div>
                <div class="list">
                    <ul>
                        ...
                        <li @click="products" :class="product ? 'bg-green-3':''" class="list-items hover:bg-green-3">Products</li>
                        <li @click="salesReport" :class="report ? 'bg-green-3':''" class="list-items hover:bg-green-3">Sales report</li>
                        <li @click="shopCashbox" :class="cashbox ? 'bg-green-3':''" class="list-items hover:bg-green-3">Cashbox</li>
                    </ul>
                </div>
            </div>
